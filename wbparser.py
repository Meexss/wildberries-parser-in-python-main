...
class WildBerriesParser:
    ...
    def get_sales_data(self):
        ...
        the request, indicating a connection timeout or empty response, the
        sales data is set to 'нет данных'. Progress information is printed during
        the iteration.
        ...
        for card in self.product_cards:
            ...
            except (requests.ConnectTimeout, IndexError, KeyError):
    ...
    def run_parser(self):
        ...
        Returns:
            None
        """
        instructions = """Введите 1 для парсинга категории целиком,
